...
class BarkadaMenuPage extends StatefulWidget {
  const BarkadaMenuPage({super.key});

  @override
  State<BarkadaMenuPage> createState() => _BarkadaMenuPageState();
}

class _BarkadaMenuPageState extends State<BarkadaMenuPage> {
  final List<Map<String, dynamic>> icedCoffees = [
    {
      'name': 'XBITE REGULAR BURGER',
      'sizes': {'Good for 6-8 people': 399},
      'selectedSize': 'Good for 6-8 people',
      'qty': 1,
    },
  ];
